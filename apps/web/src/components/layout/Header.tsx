...
export const Header: React.FC<HeaderProps> = ({ 
  ...
  return (
    <header
      className={`backdrop-blur-xl bg-white/70 dark:bg-gray-900/70 border-b border-gray-200/50 dark:border-gray-700/50 flex-shrink-0 ${className}`}
    ...
    >
      <div className="px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          {/* Center section - Breadcrumbs for desktop */}
