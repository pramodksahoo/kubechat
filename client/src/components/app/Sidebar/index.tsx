...
import kcLogoDark from '../../../assets/kc-dark-theme.svg';
import kcLogoDarkIcon from '../../../assets/kubechat-logo-light.svg';
import kcLogoLight from '../../../assets/kc-light-theme.svg';
import kcLogoLightIcon from '../../../assets/kubechat-logo-dark.svg';
                        ...
                        <div className={`flex items-center ${open || openMobile ? "justify-start pl-4" : "justify-center"}`}>
                          <a onClick={() => onNavClick('pods')}>
                            <img
                              ...
                              src={getSystemTheme() === 'light' ? (open || openMobile ? kcLogoLight : kcLogoLightIcon) : (open || openMobile ? kcLogoDark : kcLogoDarkIcon)}
                              alt="kubechat"
                            />
                          </a>
                        </div>
