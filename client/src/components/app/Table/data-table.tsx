  ...
  return (
    <>
      ...
      }
      {
        ...
        <div className='flex items-center justify-between rounded-md bg-destructive/90 text-destructive-foreground text-xs font-light px-2 py-1'>
          <span className='text-xs text-white'>We detected you are on Safari browser and are using http. For seemless expereince switch over to chrome/firefox. More details <a className='underline' href='https://github.com/pramodksahoo/kubechat/wiki/FAQ#https' target='blank'>here</a></span>
        </div>
      }
      <ResizablePanelGroup
