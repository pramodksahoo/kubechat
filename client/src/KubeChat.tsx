...
import { PlanPreviewDrawer } from "@/components/app/PlanPreview";

export function KubeChat() {
            ...
            <div className="h-screen flex">
              <div className="flex-shrink-0 border-r basis-12 bg-muted/50 flex flex-col items-center overflow-hidden relative">
                ...
                <div className="sticky bottom-0 w-full flex justify-center p-2 bg-muted/50">
                  <GitHubLogoIcon className="w-6 h-6 cursor-pointer" onClick={() => window.open('https://github.com/pramodksahoo/kubechat')} />
                </div>
              </div>
              <div className="flex flex-1 overflow-hidden">
                <div className="flex-1 overflow-hidden"><App /></div>
                <PlanPreviewDrawer />
              </div>
            </div>
          :
