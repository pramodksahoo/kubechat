...
var rootCmd = &cobra.Command{
	Use:   "kubechat",
	Short: "kubechat",
	Long:  `kubechat is a single binary web app to manage multiple clusters https://github.com/pramodksahoo/kubechat`,
...
func Serve(cmd *cobra.Command) error {
	...
	// Backcard compatibility: fallback to --port if --listen is not set
